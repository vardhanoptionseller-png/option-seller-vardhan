...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-20 pb-16 min-h-screen flex items-center bg-gradient-to-br from-background via-background to-muted/30">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-gradient-primary shadow-premium px-8 py-6 text-lg">
                Start Free Trial
              </Button>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
              {stats.map((stat, index) => (
                <Card key={index} className="p-4 text-center border-border/50 hover:shadow-card transition-all duration-300">
          ...
          <div className="relative">
            ...
            {/* Floating Elements */}
            <Card className="absolute -bottom-6 -left-6 p-4 bg-card/95 backdrop-blur-sm border-border/50">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-financial-green rounded-full animate-pulse"></div>
                <div>
